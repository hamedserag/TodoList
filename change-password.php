...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "SELECT `pass` FROM  `users` WHERE `id`='$uid'");
        ...
        if ($num > 0) {
            ...
            if (password_verify($password, $dbpassword)) {
                ...
                $con = mysqli_query($con, "UPDATE `users` SET `pass`='$newhashedpass' WHERE `id`='$uid'");
...
?>
    ...
    <head>
        ...
        <title>Blockchain | Change Password</title>
