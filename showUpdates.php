                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Show Rent Payments</h4>
                                    ...
                                    <div class="demo-box m-t-20">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = mysqli_query($con, "Select id,rname,rentValue,lastMonth from residents WHERE 1");
                                                    while ($row = mysqli_fetch_array($query)) {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo htmlentities($row['id']); ?></td>
                                                            <td><?php echo htmlentities($row['rname']); ?></td>
                                                            <td><?php echo htmlentities($row['rentValue']); ?></td>
                                                            <td><?php echo htmlentities($row['lastMonth']); ?></td>
